...
def clean_paragraph(paragraph):
    """
    Функція видаляє усі знаки пунктуації, спеціальні символи, теги та числа з абзацу тексту, а також перетворює слова у нижній регістр.
    ...
    # Перетворюємо слова у нижній регістр
